...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_CANNOT_LOGIN_QUESTION'	=> 'Tại sao tôi không thể đăng nhập tài khoản của mình?',
	'HELP_FAQ_LOGIN_CANNOT_REGISTER_ANSWER'	=> 'Có thể diễn đàn đã khóa chức năng đăng ký thành viên hoặc IP của bạn bị khóa hoặc username của bạn đã bị khóa bởi Ban Quản Trị. Vui lòng liên hệ Ban Quản Trị để được giải đáp.',
	...
	'HELP_FAQ_LOGIN_REGISTER_ANSWER'	=> 'Bạn nên đăng ký tài khoản tài diễn đàn để được hưởng toàn bộ quyền lợi của thành viên khi tham gia đăng ký tại diễn đàn này. Việc này không bắt buộc nhưng giúp ích được cho bạn rất nhiều.',
	...
	'HELP_FAQ_LOGIN_REGISTER_QUESTION'	=> 'Tại sao bạn cần đăng ký tài khoản',

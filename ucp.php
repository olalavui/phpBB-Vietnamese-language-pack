...
$lang = array_merge($lang, array(
	'ACCOUNT_ACTIVE'				=> 'Tài khoản của bạn đã được kích hoạt. Hãy tham gia nhiệt tình nhé.',
	...
	'ACCOUNT_ADDED'					=> 'Tài khoản của bạn đã được tạo. Hãy đăng nhập vào tài khoản.',
	'ACCOUNT_COPPA'					=> 'Tài khoản của bạn đã được tạo, vui lòng xác nhận qua email.',
	...
	'BACK_TO_LOGIN'				=> 'Quay lại khung đăng nhập',
	'BIRTHDAY'					=> 'Sinh nhật',
	...
	'HIDE_ONLINE'				=> 'Ẩn trạng thái trực tuyến',
	...
	'IMPORTANT_NEWS'			=> 'Thông báo quan trọng',
	...
	'LOGIN_KEY'					=> 'Key đăng nhập',
	'LOGIN_TIME'				=> 'Thời gian đăng nhập',
	'LOGIN_REDIRECT'			=> 'Bạn đã đăng nhập thành công.',
	...
	'LOGOUT_REDIRECT'			=> 'Bạn đã đăng xuất thành công.',
	...
	'SEARCH_YOUR_POSTS'			=> 'Xem bài viết',
	...
	'TIMEZONE_INVALID'			=> 'Timezone bạn chọn không đúng.',
	'TO'						=> 'Người nhận',
	'TO_MASS'					=> 'Người nhận',
	'TO_ADD'					=> 'Thêm người nhận',
	'TO_ADD_MASS'				=> 'Thêm người nhận',
	...
	'UCP_MAIN'					=> 'Tổng quan',
	'UCP_MAIN_ATTACHMENTS'		=> 'Quản lý đính kèm',
	'UCP_MAIN_BOOKMARKS'		=> 'Quản lý bookmark',
	'UCP_MAIN_DRAFTS'			=> 'Quản lý nháp',
	'UCP_MAIN_FRONT'			=> 'Front page',
	'UCP_MAIN_SUBSCRIBED'		=> 'Quản lý theo dõi',
	...
	'UCP_PM'					=> 'Tin nhắn',
	'UCP_PM_COMPOSE'			=> 'Gửi tin nhắn',
	'UCP_PM_DRAFTS'				=> 'Manage PM drafts',
	'UCP_PM_OPTIONS'			=> 'Rules, folders &amp; settings',
	'UCP_PM_UNREAD'				=> 'Tin nhắn chưa đọc',
	'UCP_PM_VIEW'				=> 'Xem tin nhắn',

	'UCP_PROFILE'				=> 'Thông tin cá nhân',
	'UCP_PROFILE_AVATAR'		=> 'Sửa avatar',
	'UCP_PROFILE_PROFILE_INFO'	=> 'Sửa profile',
	'UCP_PROFILE_REG_DETAILS'	=> 'Sửa thiết lập tài khoản',
	'UCP_PROFILE_SIGNATURE'		=> 'Sửa chữ ký',
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'Quản lý “Remember Me” login keys',

	'UCP_USERGROUPS'			=> 'Nhóm',
	'UCP_USERGROUPS_MEMBER'		=> 'Sửa memberships',
	...
	'UCP_WELCOME'					=> 'Chào mừng đến bảng điều khiển cá nhân. Tại đây bạn có thể thay avatar, chữ ký, gửi PM (nếu được phép). Hãy luôn đọc quy định diễn đàn trước khi làm bất cứ điều gì.',
	'UCP_ZEBRA'						=> 'Friends &amp; Foes',
	'UCP_ZEBRA_FOES'				=> 'Manage foes',
	'UCP_ZEBRA_FRIENDS'				=> 'Quản lý bạn bè',

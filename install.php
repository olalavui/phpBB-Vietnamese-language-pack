...
$lang = array_merge($lang, array(
	...
	// Install page
	'INSTALL_INTRO'			=> 'Chào mừng cài đặt',
	...
	'INSTALL_PHPBB_INSTALLED'		=> 'phpBB đã được cài.',
	'INSTALL_PHPBB_NOT_INSTALLED'	=> 'phpBB chưa được cài.'
));
...
$lang = array_merge($lang, array(
	...
	// Admin data
	//
	'STAGE_ADMINISTRATOR'	=> 'Thông tin tài khoản quản trị',

	// Form labels
	'ADMIN_CONFIG'				=> 'Administrator configuration',
	'ADMIN_PASSWORD'			=> 'Mật khẩu',
	'ADMIN_PASSWORD_CONFIRM'	=> 'Nhập lại',
	'ADMIN_PASSWORD_EXPLAIN'	=> 'Nhập mật khẩu từ 3 đến 20 kí tự.',
	'ADMIN_USERNAME'			=> 'Username',
	'ADMIN_USERNAME_EXPLAIN'	=> 'Nhập username từ 3 đến 20 kí tự.',

	// Errors
	'INST_ERR_EMAIL_INVALID'		=> 'The email address you entered is invalid.',
	'INST_ERR_PASSWORD_MISMATCH'	=> 'Mật khẩu không khớp.',
	'INST_ERR_PASSWORD_TOO_LONG'	=> 'Mật khẩu quá dài. Tối đa 30 kí tự.',
	'INST_ERR_PASSWORD_TOO_SHORT'	=> 'Mật khẩu quá ngắn. Ít nhất 6 kí tự.',
	'INST_ERR_USER_TOO_LONG'		=> 'Username quá dài. Tối đa 20 kí tự.',
	'INST_ERR_USER_TOO_SHORT'		=> 'Username quá ngắn. Ít nhất 3 kí tự.',
	...
	'BOARD_DESCRIPTION'	=> 'Mô tả về diễn đàn',

	//
	// Database data
	//
	'STAGE_DATABASE'	=> 'Cài đặt Database',
...
$lang = array_merge($lang, array(
	...
	'TOPICS_TOPIC_TITLE'			=> 'Chào mừng đến với phpBB3',
));
